...
public class HistorialTramiteDAO {
	...
	public List<Map<String, Object>> READALL(String idtrab) {
		List<Map<String, Object>> LST = new ArrayList<>();
		try {
			String SQL = "SELECT RTF.ID_TRABAJADOR, RDV.ID_DET_VACACIONES, RV.TIPO, RHD.EVALUACION, RHD.ID_PASOS, TO_CHAR(RTF.FECHA_CREACION,'DD/MM/YYYY') AS FECHA_CREACION, RDV.FIRMA_SALIDA, RDV.FIRMA_ENTRADA, RV.URL AS URL_SOLICITUD, RDV.URL AS URL_PAPELETA\r\n" + 
					...
					"AND RHD.ESTADO = 1 WHERE ID_TRABAJADOR = '" +idtrab+ "'";
