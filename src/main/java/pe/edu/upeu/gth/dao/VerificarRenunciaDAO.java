...
public class VerificarRenunciaDAO implements CRUDOperations{
	String sql;
...
//    DataSource d = AppConfig.getDataSource();
    ...
    public VerificarRenunciaDAO(DataSource dataSource) {
...
//			String sql = "INSERT INTO RA_RENABAN_PASOS(ID_RENABAN,ID_PASOS,ID_USUARIO,FECHA_MOD) VALUES(?,?,?,?)";
			String sql2 = "UPDATE RA_RENABAN_PASOS SET ESTADO=1 WHERE ID_PASOS='PAS-000434' AND ID_RENABAN=?";
			String sql3 = "UPDATE RA_RENABAN_PASOS SET ESTADO=1 WHERE ID_PASOS='PAS-000435' AND ID_RENABAN=?";
//			Date date = new Date();
//			
