...
//												s += '<td><button class="notificar waves-effect waves-light btn modal-trigger teal" onclick="id("'+lista[i].ID_TRABAJADOR+'")">Adjuntar Carta de Renuncia</button>';;
...
function DetalleRenuncia(){	
	...
	$.get("AutorizarR",{idc:idc,opc:2},function(data,status){
// alert(data);
