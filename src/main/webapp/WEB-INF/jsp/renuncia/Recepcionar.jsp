...
<body class="">
	...
	<div id="main">
		...
		<section id="content" class="col m12 l12 s12">
			<div class="center">
				<h1
					style="font-family: 'Cormorant Garamond', serif; font-weight: bold">Recepcionar
				...
				<ul class="collapsible popout">
					<li id="autorize" class="active">
						<div class="collapsible-header active">
							<i class="mdi-social-notifications-on"></i> Renuncias o Abandonos
							Pendientes
						</div>
					...
					<li id="autorized" class="">
						<div class="collapsible-header">
							<i class="mdi-toggle-check-box"></i> Renuncias o Abandonos
							Autorizados
						</div>
	...
	<script
		...
		type="text/javascript"></script>
	<script
		src="<c:url value='/resources/js/businessCore/Recepcionar.js'></c:url>"
		type="text/javascript"></script>
	<!-- 		<script -->
