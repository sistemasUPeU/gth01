        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.html" class="brand-logo darken-1"><img src="<c:url value='resources/images/materialize-logo.png'/>" alt="materialize logo"></a> <span class="logo-text">Materialize</span></h1></li>
                    </ul>
...
<!-- START RIGTH BAR -->
    ...
    <footer class="page-footer">
        <div class="footer-copyright">
            <div class="container">
                Copyright © 2017 <a class="grey-text text-lighten-4"  target="_blank">Alpha Team</a> All rights reserved.
                <span class="right">Developed by <a class="grey-text text-lighten-4">Alpha Team</a></span>
            </div>
        </div>
    </footer>
