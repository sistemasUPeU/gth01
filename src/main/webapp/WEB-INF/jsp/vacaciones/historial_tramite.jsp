	...
	$("#table_contenido")
			.on(
					...
					function() {
						...
						$("#d_programacion").removeAttr("href").addClass(
								"disabled");
						$("#b_aprobacion").empty();
						$("#s1_aprobacion").empty();
						$("#s2_aprobacion").empty();
						...
						var zz = '';
						if (id == 'undefined') {
							$("#b_programacion").removeClass("disabled")
									.addClass("pink lighten-2");
											...
											function(obj) {
												...
												for (var i = 0; i < obj.length; i++) {
													...
													if (ID_PASOSOS == "PAS-000055"
															&& obj[i].EVALUACION == "1"
															&& obj[i].URL_SOLICITUD != null
															|| ID_PASOSOS == "PAS-000055"
															&& obj[i].EVALUACION == "4"
															&& obj[i].URL_SOLICITUD != null) {
														fecha = new Date(
																obj[i].FECHA_MOD);
													...
													if (obj[i].ESTADO == 1) {
														...
														if (ID_PASOS == "PAS-000055"
															...
															$("#f_programacion")
																	.append(
																			obj[i].FECHA_CREACION);
															console
																	.log("PROGRAMACION SS");
														} else if (ID_PASOS == "PAS-000055"
																&& obj[i].EVALUACION == "1"
																&& obj[i].URL_SOLICITUD != null) {
															$("#b_programacion")
																	.removeClass(
															...
															console
																	.log(
																			...
																			FECHA_MOD_CO);
															console
																	.log("EN PROCESO 2/2 xd");
														} else if (ID_PASOS == "PAS-000090"
																&& obj[i].FIRMA_SALIDA == 0
																&& obj[i].URL_PAPELETA != null) {
															$("#b_programacion")
																	.removeClass(
															...
															$("#f_papeleta")
																	.append(
																			FECHA_MOD_PA);
															console
																	.log("PAPELETA ENTREGADA");
														} else if (ID_PASOS == "PAS-000092"
																&& obj[i].FIRMA_SALIDA == 0
																&& obj[i].URL_PAPELETA != null) {
															$("#b_programacion")
																	.removeClass(
															...
															$("#f2_control")
																	.append(
																			FECHA_MOD_FI2);
															console
																	.log("FIRMA SALIDA Y ENTRADA");
														} else {
															console
																	.log("PROGRAMACION SS ELSE");
														}
														$("#t_programacion")
																.append(
																		obj[i].TIPO
