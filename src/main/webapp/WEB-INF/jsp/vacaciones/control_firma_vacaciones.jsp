					...
					function() {
						if ($(this).attr("name") == 0
							...
							if (file != "") {
								...
								Materialize
										.toast(
												'Es necesario la papeleta para continuar',
												3000, 'rounded');
							}
					...
					function() {
						...
						if (z == 6) {
							if (file != "") {
										...
										.ajax({
											...
											success : function(data) {
												...
												if (data == "0") {
													...
													Materialize
															.toast(
																	'Se excedió el tamaño máximo de papeleta permitido',
																	3000,
																	'rounded');
												} else {
													console.log("success: "
								...
								Materialize.toast('No hay papeleta', 3000,
										'rounded');
							}

							$.get('updatePapeletaFirma', {
								id : a
							}, function(data) {
